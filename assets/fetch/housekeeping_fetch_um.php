<?php
  ...
  //      $conn = mysql_connect('localhost', 'root', '');
	 //  	$db   = mysql_select_db('fides');
		...
		// $sql = "select * from room_type inner join rooms on room_type.id=rooms.room_type_id where status_by_room ='Under Maintenance'";
		// $res = mysql_query($sql);
		// $result = array();
		...
		$request = "select * from room_type inner join rooms on room_type.id=rooms.room_type_id where status_by_room ='Under Maintenance'";
