...
class Admin extends CI_Controller {
  ...
  public function index() {
    ...
    $this->load->view('body/admin/dashboard', $data);
  ...
  public function roomTypes() {
    ...
    $this->load->view('body/admin/layout/header', $data);
    $this->load->view('body/admin/add_room_types', $data);
    $this->load->view('body/admin/layout/footer');
  }
  ...
  public function updateRoomtype($id) {
    ...
    $this->load->view('body/admin/layout/header', $data);
    $this->load->view('body/admin/update_room_types', $data);
    $this->load->view('body/admin/layout/footer');
  }
  ...
  public function rooms() {
    ...
    $this->load->view('body/admin/layout/header', $data);
    $this->load->view('body/admin/add_rooms', $data);
    $this->load->view('body/admin/layout/footer');
  }
  ...
  public function updateRoom($id) {
    ...
    $this->load->view('body/admin/layout/header', $data);
    $this->load->view('body/admin/update_room', $data);
    $this->load->view('body/admin/layout/footer');
  }
  ...
  public function createUser() {
    ...
    $this->load->view('body/admin/layout/header', $data);
    $this->load->view('body/admin/create_user', $data);
    $this->load->view('body/admin/layout/footer');
  }
  ...
  public function updateUser($id) {
    ...
    $this->load->view('body/admin/layout/header', $data);
    $this->load->view('body/admin/update_user', $data);
    $this->load->view('body/admin/layout/footer');
  }
  public function updatingUsers() {
    ...
    if ($this->form_validation->run() != FALSE) {
      ...
      $this->update_model->updateUser($id);
  ...
  public function pricing() {
    ...
    $this->load->view('body/admin/layout/header', $data);
    $this->load->view('body/admin/pricing', $data);
    $this->load->view('body/admin/layout/footer');
  }
  ...
  public function CoffeeProduct() {
    ...
    $this->load->view('body/admin/layout/header', $data);
    $this->load->view('body/admin/coffeeshop_add_product', $data);
    $this->load->view('body/admin/layout/footer');
  }
  ...
  public function resProduct() {
    ...
    $this->load->view('body/admin/layout/header', $data);
    $this->load->view('body/admin/restaurant_add_product', $data);
    $this->load->view('body/admin/layout/footer');
  }
  ...
  public function deduction() {
    ...
    $this->load->view('body/admin/layout/header', $data);
    $this->load->view('body/admin/deduction', $data);
    $this->load->view('body/admin/layout/footer');
  }
  ...
  public function Updatededuction($id) {
    ...
    $this->load->view('body/admin/layout/header', $data);
    $this->load->view('body/admin/update_deduction', $data);
    $this->load->view('body/admin/layout/footer');
  }
  ...
  public function updatingDeductions() {
    ...
    $this->insert_model->log($data);
    $this->session->set_flashdata('success', '$$');
    redirect('admin/Updatededuction/' . $id);
  }
  ...
  public function Profile() {
    ...
    $this->load->view('body/admin/layout/header', $data);
    $this->load->view('body/admin/userprofile', $data);
    $this->load->view('body/admin/layout/footer');
  }
  ...
  public function createTables() {
    ...
    $this->load->view('body/admin/layout/header', $data);
    $this->load->view('body/admin/add_table', $data);
    $this->load->view('body/admin/layout/footer');
  }
  ...
  public function UpdateTables($id) {
    ...
    $this->load->view('body/admin/layout/header', $data);
    $this->load->view('body/admin/update_table', $data);
    $this->load->view('body/admin/layout/footer');
  }
  ...
  public function UpdatingTable() {
    ...
    redirect('admin/UpdateTables/' . $id);
  }
  ...
  public function coffeeshopcreateTables() {
    ...
    $this->load->view('body/admin/layout/header', $data);
    $this->load->view('body/admin/add_table_coffeeshop', $data);
    $this->load->view('body/admin/layout/footer');
  }
  ...
  public function coffeeshopUpdateTables($id) {
    ...
    $this->load->view('body/admin/layout/header', $data);
    $this->load->view('body/admin/update_table_coffeeshop', $data);
    $this->load->view('body/admin/layout/footer');
  }
  ...
  public function coffeeshopInsertTable() {
    ...
    $this->insert_model->log($data);
    $this->session->set_flashdata('success', '$$');
    redirect('admin/coffeeshopcreateTables/');
  }
  ...
  public function coffeeshopUpdatingTable() {
    ...
    $this->insert_model->log($data);
    $this->session->set_flashdata('success', '$$');
    redirect('admin/coffeeshopcreateTables/' . $id);
  }
  ...
  public function activitylogs() {
    ...
    $this->load->view('body/admin/layout/header', $data);
    $this->load->view('body/admin/activity_logs', $data);
    $this->load->view('body/admin/layout/footer');
  }
  ...
  public function userlogs() {
    ...
    $this->load->view('body/admin/layout/header', $data);
    $this->load->view('body/admin/userlogs', $data);
    $this->load->view('body/admin/layout/footer');
  }
  ...
  public function reports() {
    ...
    $this->load->view('body/admin/layout/header', $data);
    $this->load->view('body/admin/reports');
    $this->load->view('body/admin/layout/footer');
  }
  ...
  public function transactions() {
    ...
    $this->load->view('body/admin/layout/header', $data);
    $this->load->view('body/admin/transaction', $data);
    $this->load->view('body/admin/layout/footer');
  }
  ...
  public function changeToActive($id) {
    ...
    $this->update_model->changeStatusOfUsers($id, $data);
    $this->session->set_flashdata('success', '$$');
    redirect('admin/createUser/');
  }
