      ...
      <tr style="vertical-align: top">
        <td style="word-break: break-word; border-collapse: collapse !important; vertical-align: top">
          ...
          <div class="u-row-container" style="
                padding: 0px;
                background-image: url('https://booking.hoteldefides.com/assets/img/email-background.png');
                              ...
                              <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                  <td style="padding-right: 0px; padding-left: 0px" align="center">
                                    <img align="center" border="0" src="https://booking.hoteldefides.com/assets/assets/img/hdf_logo_brown.png" alt="logo" style="
                                          outline: none;
                                          ...
                                          width: 100%;
                                          max-width: 250px;
                                        " width="250" class="v-src-width v-src-max-width" />
                                  </td>
                                </tr>
                              </table>
                            </td>
                          ...
                          <tr>
                            <td class="v-container-padding-padding" style="
                              ...
                              <h1 class="v-font-size" style="
                                    ...
                                    font-size: 38px;
                                  ">
                                <strong>CONFIRM YOUR <br />RESERVATION</strong>
                              </h1>
                            </td>
                          </tr>
                        </tbody>
                        ...
                        <tbody>
                          <tr>
                            <td class="v-container-padding-padding" style="
                                  ...
                                  font-family: 'Montserrat', sans-serif;
                                " align="left">
                              <div style="color: #78574e; line-height: 140%; text-align: center; word-wrap: break-word">
                                <p style="font-size: 14px; line-height: 140%">
                                  <span style="font-size: 18px; line-height: 25.2px"><?= $date ?></span>
                                </p>
                                <p style="font-size: 14px; line-height: 140%">
                                  <span style="font-size: 18px; line-height: 25.2px">Room <?= $room_number ?> - <?= $room_type ?></span>
                                </p>
                                <p style="font-size: 14px; line-height: 140%">
                                  <span style="font-size: 18px; line-height: 25.2px">Duration : <?= $from ?> - <?= $to ?></span>
                                </p>
                              </div>
                            </td>
                          </tr>
                        ...
                        <tbody>
                          <tr>
                            <td class="v-container-padding-padding" style="
                                ...
                                " align="left">
                              <div align="center">
                                <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-spacing: 0; border-collapse: collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;font-family:'Montserrat',sans-serif;"><tr><td style="font-family:'Montserrat',sans-serif;" align="center"><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="https://www.unlayer.com" style="height:37px; v-text-anchor:middle; width:145px;" arcsize="11%" stroke="f" fillcolor="#78574e"><w:anchorlock/><center style="color:#FFFFFF;font-family:'Montserrat',sans-serif;"><![endif]-->
                                <h1 class="v-font-size" style="
                                    margin: 0px;
                                    color: #78574e;
                                    line-height: 120%;
          ...
          <div class="u-row-container" style="padding: 0px; background-color: transparent">
            <div class="u-row" style="
              ...
              <div style="
                ...
                <!--[if (mso)|(IE)]><td align="center" width="600" style="background-color: #78574e;width: 600px;padding: 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;" valign="top"><![endif]-->
                <div class="u-col u-col-100" style="max-width: 320px; min-width: 600px; display: table-cell; vertical-align: top">
                  <div style="
                            ...
                            <td class="v-container-padding-padding" style="
                              ...
                              <div style="color: #ffffff; line-height: 140%; text-align: center; word-wrap: break-word">
                                ...
                                <p style="font-size: 14px; line-height: 140%">
                                  ...
                                  |
                                  <a href="https://hoteldefides.com/" style="text-decoration: none; color: white" target="_blank">Website</a>
                                  |
                                  <a href="https://booking.hoteldefides.com/" style="text-decoration: none; color: white" target="_blank">Booking</a>
                                </p>
                              </div>
                            </td>
                          </tr>
