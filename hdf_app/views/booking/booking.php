            ...
            <div class="row">
              ...
              <div class="mt-3 col-md-9 px-0">
                <div class="bg-semi-light p-4 text-green verified" id="imageDIV">
                  ...
                  <p>Thank you for choosing Hotel De Fides. We have sent verification message to <span class="email_address"></span> to confirm your reservation. Please advise us if any changes need to be made to this reservation by calling us.</p>
                  <div class="row pt-2">
                    <div class="col-md-7">
                      ...
                      <table class="table table-sm table-bordered bg-light" style="height:368.35px">
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td colspan="2">
                              <ol>
                                <li>All payments received by the Hotel de Fides is NON-REFUNDABLE.</li>
      ...
      if (!first_name || !last_name || !email || !contact) {
        ...
        $.ajax({
          ...
          success: function(response) {
            ...
            $('#td_departure').text(`${check_out} - ${nights} nights`);
