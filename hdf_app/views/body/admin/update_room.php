      ...
      <div class="card ">
        ...
        <div class="card-body ">
          ...
          <form action="<?php echo base_url() ?>index.php/admin/updatingRoom" method="post" class="form-horizontal">
            ...
            <input type="hidden" name="id" value="<?php echo $result_rooms_by_id->id ?>">
              ...
              <div class="col-sm-12">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" required name="room_type_id">
                    ...
                    <option value="<?php echo $result_rooms_by_id->room_type_id ?>"><?php echo $result_rooms_by_id->room_type ?></option>
            ...
            <div class="row">
              <div class="col-sm-12">
                ...
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" name="room_number" value="<?php echo $result_rooms_by_id->room_number ?>">
            ...
            <div class="row">
              <div class="col-sm-12">
                ...
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" name="person" value="<?php echo $result_rooms_by_id->persons ?>">
