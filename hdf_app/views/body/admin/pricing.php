        ...
        <div class="card-body">
          ...
          <table id="datatable" class="table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            <tbody>
              ...
              ?>
                <tr>
                  <td><?php echo $data['add_person'] ?></td>
                  <td>
                    <div class="third">&nbsp; <?php echo $data['person_pricing'] ?></div>
                    <input type="number" class="thirdedit" value="<?php echo $data['person_pricing'] ?>" id="person_pricing/<?= $data['id'] ?>">
                  </td>
                  <td><?php echo $data['person_date_modified'] ?></td>
