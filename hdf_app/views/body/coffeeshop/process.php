  ...
  <div class="row">
          ...
          <form action="<?php echo base_url() ?>index.php/main/addCartRestaurant" method="post" class="form-horizontal">
            ...
            <div class="row">
              <div class="col-sm-12">
                ...
                <select class="selectpicker form-control" name="product_name" data-live-search="true">
    ...
    <div class="col-md-6">
      <div class="card ">
        <div class="card-header ">
          <div class="timeline-heading">
            <span class="badge badge-pill badge-danger">Product Cart</span><a id="<?php echo base_url() ?>index.php/main/clearCart" class="clear float-right btn btn-danger btn-link" data-placement="left" title="Clear Cart" rel="tooltip"><i class="fa fa-times"></i></a>
            <?php if (!empty($product_cart)) : ?>


              <a id="" data-toggle="modal" data-user="<?php echo $sess ?>" data-deduction="<?php echo $type ?>" data-id="<?php echo $id_num ?>" data-client="<?php echo $client ?>" class="senior float-right btn btn-danger btn-link" data-target="#ModalRoom2" data-placement="left" title="Discounted Form" rel="tooltip"><i class="fa fa-plus"></i></a>
            <?php endif ?>
        ...
        <div class="card-body ">
          ...
          ?>
            ...
            <div class="row">
              ...
              <label class="col-sm-3 col-form-label">P <b style="color:red">-<?php echo $total_amount[0]['total'] * ".$percent" ?></b></label>
              <label class="col-sm-1 col-form-label"></label>
            </div>
            <hr>
            <div class="row">
              <label class="col-sm-3 col-form-label"><button onclick="popupCenter('<?php echo base_url('index.php/main/printRecieptRestaurant/') ?>',  'myPop1', 600,600); return false;" class="btn btn-primary">Print Reciept</button></label>
              <label class="col-sm-2 col-form-label"></label>
            ...
            <tbody>
              <?php foreach ($product_cart_deleted as $data) { ?>
                <tr>
                  ...
                  <td>
                    <center><button id="<?php echo base_url('index.php/main/restaunratChangeToDeliveredPertable/' . $data['id_cart']) ?>" class="deliver btn btn-primary ">Delivered</button></center>
                  </td>
                </tr>
