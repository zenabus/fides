...
<?php
$new_start_date = "05/02/2023";
$new_end_date = "05/05/2023";

// $query = "SELECT * FROM bookings
//           WHERE ('01/02/2022' <= 'end_date' AND '01/03/2022' >= 'start_date')
//              OR ('01/02/2022' <= 'end_date' AND '01/03/2022' >= 'start_date')";

$query = $this->db->query("SELECT * FROM bookings where 
                  (start_date <= '$new_start_date' AND end_date >= '$new_start_date') OR
                 (start_date <= '$new_end_date' AND end_date >= '$new_end_date') OR
