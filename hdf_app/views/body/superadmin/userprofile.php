  ...
  <div class="row">
    ...
    <div class="col-md-6">
      <div class="card ">
        ...
        <div class="card-body ">
          <form action="<?php echo base_url() ?>index.php/admin/UpdateProfileDetails" method="post" class="form-horizontal">
      ...
      <div class="card ">
        <div class="card-header ">
          <div class="timeline-heading">
            ...
            <!-- <span class="badge badge-pill badge-danger">Profile Picture</span> -->
          </div>

        </div>
        <div class="card-body ">
          <form action="<?php echo base_url() ?>index.php/admin/UploadImage" method="post" enctype="multipart/form-data" class="form-horizontal">
            <center>
              <div class="col-md-12">
