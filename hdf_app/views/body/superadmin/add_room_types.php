    ...
    <div class="col-md-12">
      ...
      <div class="card">
        <div class="card-header">
          ...
          <div class="timeline-heading">
            <h6><b>ROOM TYPE</b></h6>
              <span class="badge badge-pill badge-danger">Add a Room Type</span>
          </div>
        </div>
        <div class="card-body ">
          <form  action="<?php echo base_url() ?>index.php/admin/insertRoomType" method="post" enctype="multipart/form-data" class="form-horizontal">
          <div class="row">
            <div class="col-sm-12">
              <label class="form-label">Type</label>
                <div class="form-group">
                  <input type="text" class="form-control" name="roomtype" required disabled="disabled">
                </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-sm-12">
              <label class="form-label">Description</label>
                <div class="form-group">
                  <input type="text" class="form-control" name="details" required disabled="disabled">
                </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-sm-12">
              <label class="form-label">Number of Person(s)</label>
                <div class="form-group">
                  <input type="text" class="form-control" name="persons" required disabled="disabled">
                </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-sm-12">
              <label class="form-label">Amenities</label>
                <div class="form-group">
                  <textarea class="form-control" name="amenities" disabled="disabled"></textarea>
                </div>
            </div>
          </div>
      </div>
                  ...
                  <div class="form-group">
                    <div class="fileinput fileinput-new text-center" data-provides="fileinput" style="width:250; height:250">
                      <div class="fileinput-new thumbnail">
                        <img src="<?php echo base_url() ?>uploaded_files/1.jpg" alt="files" width="200" height="200">
                      </div>
                      <div class="fileinput-preview fileinput-exists thumbnail"></div>
                      <div>
                        <span class="btn btn-rose btn-round btn-file" disabled="disabled">
                          <span class="fileinput-new">Choose image</span>
                          <span class="fileinput-exists">Change</span>
                          <input type="file" name="files" required disabled="disabled">
                        </span>
                  ...
                  <div class="card-footer ">
                    <div class="row">
                      <label class="col-sm-2 col-form-label"></label>
                        <div class="col-md-12" >
                          <input type="submit" class="btn btn-success" value="Add" disabled="disabled">
                          <input type="reset" class="btn btn-info " value="Clear" disabled="disabled">  -->
